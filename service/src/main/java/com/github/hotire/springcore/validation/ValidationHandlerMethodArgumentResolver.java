...
public class ValidationHandlerMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter methodParameter) {
        return com.github.hotire.springcore.validation.Validation.class.equals(methodParameter.getParameterType());
    }
    ...
    public Object resolveArgument(MethodParameter methodParameter, ModelAndViewContainer modelAndViewContainer, NativeWebRequest nativeWebRequest, WebDataBinderFactory webDataBinderFactory) throws Exception {
        ...
        final com.github.hotire.springcore.validation.Validation validation = Optional.ofNullable(searchParameter)
                                                                                      .map(this::parseSearch)
                                                                                      .orElse(new com.github.hotire.springcore.validation.Validation());
    ...
    private com.github.hotire.springcore.validation.Validation parseSearch(String[] searchParameter) {
